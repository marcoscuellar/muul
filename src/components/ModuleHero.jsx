...
export default function ModuleHero({ vals }) {
  return (
    <>
      <div className="introrow" style={{ padding: '36px 0 18px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 40 }}>
        <h1 className="hero" style={heroTitle(vals.A, vals.ON)}>{vals.headerTitle}</h1>
